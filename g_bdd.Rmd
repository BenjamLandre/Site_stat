...
Certains individus sont present dans les deux BDD, tandis que certains ne sont presents que dans une des deux. 
...
id.2<- 35:80
val2<- rnorm(46,25,3)
D2<- data.frame(ID= id.2, VAL2= val2) #46 observations de 2 variables: ID, VAL3
str(D2)
...
New_bdd<- dplyr::inner_join(D1,D2) #on conserve l'information des individus presents a la fois dans D1 et D2
str(New_bdd)
```
...
| left_join(bdd1, bdd2)  | joindre a bdd1 les donnees de bdd2, des individus de bdd1 presents dans bdd2 |
| inner_join(bdd1, bdd2) | joindre bdd1 et bdd2 en ne conservant que ceux presents dans les deux bdd    |
