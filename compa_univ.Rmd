...
On souhaite tester statistiquement la différence entre deux groupes.
...
t.test(ais$ferr ~ ais$sex, #variable ~ groupes a comparer
...
tableau_contingence #on observe d'emblee des valeurs theoriques trop faibles pour le calcul.
...
chisq.test(tableau_contingence,
           correct = T)$expected #affiche les effectifs attendus
