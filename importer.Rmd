...
On peut acceder aux valeurs comprisent dans la matrice de la meme facon que l'on selectionne un sous-ensemble d'un vecteur.  
...
D1<- data.frame(Colone1= a, Colone2= b)
...
D1[D1$Colone2>2,] # on souhaite dans D1, les lignes pour lesquels la valeur de la deuxieme colonne de D1 est superieur a 2, on en souhaite toutes les colonnes.
```
...
[Pour s'entrainer]()mettre un lien vers doc pdf avec exos de gestion de base de base de donnee et subset ++++.