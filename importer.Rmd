...
C'est a dire uniquement des chiffres, du texte ou des resultats logiques (= Vrai ou Faux).
...
Un objet qui regroupe des vecteurs de differents types est appele une liste. 
...
D1[D1$Colonne2>2,] # on souhaite dans D1, les lignes pour lesquelles la valeur de la deuxieme colonne de D1 est superieure a 2, avec presentation de toutes les colonnes.
